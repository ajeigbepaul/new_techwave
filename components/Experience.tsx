    ...
    <section className="w-full h-auto mt-10 md:pb-10">
      <div className="w-full flex items-start justify-center flex-col">
        <div className=" flex items-start justify-center flex-col w-full">
          <h2 className="text-black font-bold text-[40px] max-lg:text-[32px] max-md:text-[24px] md:w-[40%] font-grotesque text-left mt-5">
            Our experience covers a wide range of{" "}
            <span className="text-brandcolor">industries.</span>
          </h2>
        </div>
        <div className="md:grid md:grid-cols-3 flex overflow-x-auto gap-4 mt-10">
          {experience.map((item: experienceProp, idx: number) => (
            <Card
              ...
              cardClass={
                "h-[280px] max-md:h-[250px] !min-w-[250px] rounded-3xl"
              }
              id={2}
