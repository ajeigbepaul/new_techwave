...
const Footer = () => {
  return (
    <footer className="w-full border-t border-t-[#B7CFFF] mt-4 md:mt-0 px-4 py-12">
      <div className="w-4/5 max-md:w-[95%] mx-auto">
        <div className="w-full grid md:grid-cols-2">
          <div className="w-full flex flex-col space-y-5 mt-2 px-4 md:px-0">
            ...
            <div className="flex flex-col mb-4">
              <h2 className="md:text-[16px] text-lg text-black font-semibold">
                Address
              </h2>
              <h2 className="md:text-[16px] text-lg text-[#7A8AAB]">
        ...
        <div className="w-full bg-[#B7CFFF] h-[1px]" />
