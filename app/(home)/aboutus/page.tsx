  ...
  return (
    <section className="w-full max-w-5xl mx-auto min-h-screen px-4 lg:px-0 lg:mt-14 md:mt-14 mt-0">
      <div className="w-full relative lg:pt-14 md:pt-0 pt-52 ">
        ...
        <div className="lg:w-[60%] md:w-[50%] md:flex hidden flex-col space-y-2 rounded-xl p-4 px-4  bg-black border-4 border-brandcolor absolute left-[30px] lg:-bottom-20 -bottom-32">
